  ...
  return (
    ...
    >
      <div className="flex flex-col gap-8 w-full">
        ...
        <input
          className="text-24 text-white outline-none w-full  bg-transparent"
          placeholder="0.0"
        />
      </div>
      <div className="flex items-center gap-4">
        ...
        >
          <Icon
            ...
            className={`transition-all duration-200 w-32 h-32 ${
