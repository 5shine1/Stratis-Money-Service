...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <nav className="flex items-center gap-8 md:gap-48 lg:gap-64 max-w-1520 mx-auto">
          ...
          <div
            className={`relative  ${email ? "hidden md:block" : "hidden"}`}
            ref={useClickOutside(() => {
          ...
          <Link href={"/auth/login"} className={`${email ? "hidden" : "hidden md:block"}`}>
