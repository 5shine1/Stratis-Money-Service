...
const OrderPage = () => {
  ...
  return (
    <div className="flex flex-col gap-24 lg:gap-48 lg:p-48 py-32 p-8 text-14">
      <h2 className="w-fit">User Detail</h2>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col gap-32">
          <div className="flex flex-col md:flex-row gap-16">
            <div className="p-32 rounded-8 bg-white/5  w-full md:max-w-420">
              <div className="text-20 font-bold text-secondary-200"> User Detail</div>
              <div className="flex flex-col gap-12 mt-18">
                <span>
                  <span className="text-white/60">Name: </span>John Doe{" "}
                  <span className="text-success border  px-4 py-2 border-success rounded-4 text-12">Admin</span>
                </span>
                <span>
                  <span className="text-white/60">Email: </span>johndoe@stratis.com
                </span>
                <span>
                  <span className="text-white/60">Phone: </span>+12737713322
                </span>
                <span>
                  <span className="text-white/60">Location: </span>United States
                </span>
                <span>
                  <span className="text-white/60">Member from: </span>United States
                </span>
              </div>
            </div>
            <div className="p-32 rounded-8 bg-white/5  w-full md:max-w-420">
